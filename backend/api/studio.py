...
from backend.core.config import (
    ROOT, DIST_DIR, ASSETS_DIR, PROFILE_PHOTO, load_resume_config, TEMPLATES_DIR,
)
from backend.core.upload import list_r2_objects, upload_pdf, get_r2_client, BUCKET
from backend.core.deps import get_user_id, get_optional_user_id

from backend.db import db
from backend.services.resume_service import get_full_config, save_full_config
...
def compile_direct(req: DirectCompileRequest, request: Request = None):
    from backend.core.build import build_variant
    from backend.core.config import TEMPLATE_PHOTO, TEMPLATE_PLAIN, TEMPLATE_COVER_LETTER
    import re as _re
...
def upload_all_files():
    from backend.core.config import DIST_DIR
